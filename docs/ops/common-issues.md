...
| «У всех RU мёртв», Direct OK; IP Timeweb; spamlist чист | Ad-hoc retarget Aug 7 → timeweb; **канон Aug 8:** Google BRIDGE по architecture/principles (пик Aug 2–4) | Sub URI `sni` == live `serverNames`; не смешивать Google URI с timeweb Reality | Refresh `:2080`; вручную **🇷🇺 RU** 60с; смотреть accepts с PC |
